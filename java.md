...
- [Seconds](src/seconds/Seconds.java)
...
#### Your answer: I can generate a random number with a Math.random() function, and it generate a random number between 0 and 1.
